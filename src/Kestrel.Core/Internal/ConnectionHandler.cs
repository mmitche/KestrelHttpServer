...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal
{
    public class ConnectionHandler : IConnectionHandler
    {
        ...
        public void OnConnection(IFeatureCollection features)
        {
            ...
            var inputOptions = GetInputPipeOptions(_serviceContext, connectionContext.MemoryPool, transportFeature);
            var outputOptions = GetOutputPipeOptions(_serviceContext, connectionContext.MemoryPool, transportFeature);
